...
if st.session_state["rebuild_index"]:
    st.info("⏳ Rebuilding retriever... please wait.")
elif st.session_state["retriever_initialized"]:
    st.success("✅ Retriever initialized and ready.")
else:
    st.warning("❌ Retriever not yet initialized. Click **Rechunk & Reindex** to build.")
