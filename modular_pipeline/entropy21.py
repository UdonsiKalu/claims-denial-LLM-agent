...
if "entropy_df" in st.session_state:
    ...
    with col2:
        ...
        # Interactive matrix rendering
        fig = px.imshow(
            matrix_display_df,
            labels=dict(x="Chunks", y="Queries", color="Retrieval Count"),
            color_continuous_scale="YlGnBu",
            height=min(1000, 40 * len(matrix_display_df)),  # dynamic height
        )
        ...
        st.plotly_chart(fig, use_container_width=True, key="entropy_matrix_chart")
