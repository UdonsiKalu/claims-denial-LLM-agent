...
# --- Streamlit UI ---
st.title("📑 Multi-Select Regex Chunker")
...
if uploaded:
    ...
    selected_lines = st.multiselect(
        "👉 Select one or more lines that look like headers/chapters", preview_lines
    )
